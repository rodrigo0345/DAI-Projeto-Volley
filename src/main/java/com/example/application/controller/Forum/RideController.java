...
public class RideController {
  ...
  public ResponseEntity<ResponseType<Ride>> findById(Integer id)
      throws Exception {
  ...
  public ResponseEntity<Boolean> removePassenger(PostType post,
                                                 LoginUser user) {
    PostSavedType type = post.getType();
    if (post == null || type.equals(PostSavedType.NEWS))
      return ResponseEntity.badRequest().body(false);
  ...
  public ResponseEntity<Boolean> checkPassengerInRide(Ride ride,
                                                      LoginUser user) {
