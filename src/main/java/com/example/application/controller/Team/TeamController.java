...
public class TeamController {
  ...
  createTeamWithManager(LoginUser loginUser, List<Integer> jogadores,
    ...
    Team createdTeam =
        teamService.criarEquipa(teamRepository, user, jogadores, escalao, name)
            .success;
  ...
  createTeamWithAdmin(LoginUser loginUser, List<Integer> equipa,
    ...
    Team createdTeam =
        teamService.criarEquipa(teamRepository, user, equipa, escalao, name)
            .success;
  ...
  editTeam(LoginUser currentUser, Integer teamId, Integer managerId,
    ...
    // verificar se o nome do treinador é válido (nao vazio) MESMA CENA DE CIMA
    // IDK
  ...
  public ResponseEntity<ResponseType<Team>> removeTeam(LoginUser loginUser,
    ...
    if (!(user.getId().equals(
              teamRepository.findById(teamId).get().getManager().getId()) ||
  ...
  addPlayer(LoginUser currentUser, Integer teamId, List<Integer> equipa) {
    ...
    for (User user : atletas) {
      if (jogadoresEmEquipas.contains(user)) {
        var response = new ResponseType<Team>();
        response.error(user.getFirstname() + " " + user.getLastname() +
    ...
    Team addedPlayerTeam =
        teamService.adicionarJogador(teamRepository, teamId, atletas).success;
  ...
  removePlayer(LoginUser loginUser, Integer teamId,
    ...
    if (teamRepository.findById(teamId).get().getPlayers().contains(
            jogadoresRemovidos)) {
      var response = new ResponseType<Team>();
  ...
  isPlayerInTeam(List<Long> atletas) {
