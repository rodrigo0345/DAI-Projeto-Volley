...
public class GameController {
  ...
  public Iterable<Game> getAllGames() { return gameRepository.findAll(); }

  public ResponseEntity<ResponseType<Game>>
  createGame(LocalDateTime date, String teamID, List<Integer> gameCall,
    ...
    if (gameCall.isEmpty() || opponent.trim().isEmpty() ||
        local.trim().isEmpty()) {
      var response = new ResponseType<Game>();
    ...
    Game createdGame = GameService
                           .createGame(gameRepository, teamRepository, gameCall,
                                       teamID, opponent, date, local)
                           .success;
    var response = new ResponseType<Game>();
  ...
  public ResponseEntity<ResponseType<Game>>
  editGame(List<Integer> gameCall, String teamID, String opponent, String date,
           String local, Integer gameId, LoginUser user) {
    ...
    Game editedGame =
        GameService
            .editGame(gameRepository, teamRepository, gameId, teamID, opponent,
                      startDateTime, local, gameCall)
            .success;
  ...
  public ResponseEntity<ResponseType<Game>> removeGame(Integer gameID,
    ...
    Game deletedGame = GameService.removeGame(gameRepository, gameID).success;
