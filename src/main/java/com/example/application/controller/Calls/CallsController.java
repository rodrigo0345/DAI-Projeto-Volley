...
public class CallsController {
  ...
  public ResponseEntity<ResponseType<Convocatorias>>
  createCall(List<Long> atletas, String titulo, String description,
             LocalDateTime date, Long idManager) {
    ...
    Convocatorias createdCall =
        CallsService
            .createCall(convocatoriasRepository, atletas, titulo, description,
                        date, idManager)
            .success;
  ...
  public ResponseEntity<ResponseType<Convocatorias>>
  editCall(List<Long> atletas, String titulo, String description,
           LocalDateTime date, Long idManager, Long callId) {
    ...
    Convocatorias editedCall =
        CallsService
            .editCall(convocatoriasRepository, callId, titulo, description,
                      date, idManager, atletas)
            .success;
  ...
  public ResponseEntity<ResponseType<Convocatorias>>
  removeCall(Long convocatoriaID, LoginUser loginUser) {
    ...
    Convocatorias deletedCall =
        CallsService.removeCall(convocatoriasRepository, convocatoriaID)
            .success;
  ...
  public ResponseEntity<ResponseType<Convocatorias>>
  addPlayer(List<Long> atletas, Long convocatoriaID, LoginUser loginUser) {
    ...
    Convocatorias addedPlayers =
        CallsService
            .addPlayers(atletas, convocatoriaID, convocatoriasRepository)
            .success;
  ...
  public ResponseEntity<ResponseType<Convocatorias>>
  removePlayer(LoginUser loginUser, Long convocatoriaId, List<Long> atletasId) {
    ...
    Convocatorias removedPlayers =
        CallsService
            .removePlayers(atletasId, convocatoriaId, convocatoriasRepository)
            .success;
