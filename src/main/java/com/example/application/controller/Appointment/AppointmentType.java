...
public class AppointmentType implements Comparable<AppointmentType> {
  ...
  public AppointmentSavedType getType() {
    if (physicalAppointment != null)
      return AppointmentSavedType.PHYSICAL;
    else if (technicalAppointment != null)
      return AppointmentSavedType.TECHNICAL;
    else if (psychologicalAppointment != null)
      return AppointmentSavedType.PSYCHOLOGICAL;
    return null;
  }

  public <T> T returnType() {
    if (physicalAppointment != null)
      return (T)physicalAppointment;
    else if (technicalAppointment != null)
      return (T)technicalAppointment;
    else if (psychologicalAppointment != null)
      return (T)psychologicalAppointment;
    return null;
  }
