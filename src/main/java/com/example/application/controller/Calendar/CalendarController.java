...
public class CalendarController {
  ...
  public List<Event> getAllEvents() {
    var events = CalendarService.getAllEvents(
        ridesRepository, newsRepository, calendarRepository, practiceRepository,
        appointmentRepository);
    return events;
  }

  public List<Event> getEventsByPerson(Integer id) {
    var events = CalendarService.getEventsByUser(
        id, ridesRepository, newsRepository, gameRepository, practiceRepository,
        appointmentRepository, usersRepository, teamRepository);
    return events;
  }

  public List<Event> getAllTrainingEvents(Practice practice) {
    List<Event> events = CalendarService.getAllTrainingEvents(
        ridesRepository, newsRepository, gameRepository, practiceRepository,
        appointmentRepository);
    return events;
  }
}
