...
public class AuthenticationController {
  ...
  public ResponseEntity<ResponseType<LoginUser>>
  signup(@RequestBody LoginUser currentUser,
  ...
  public ResponseEntity<ResponseType<LoginUser>> login(String email,
                                                       String password)
      throws Exception {
    ...
    LoginUser loginUser = new LoginUser(
        ...
        user.getAge(), user.getRole().toString(), token.getToken());
