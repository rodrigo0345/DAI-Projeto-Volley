...
public class AuthControllerTest {
  ...
  private UserRepository user =
      Mockito.mock(UserRepository.class, Mockito.CALLS_REAL_METHODS);
  @Mock
  ...
  public void testRegister() {
    ...
    String token =
        Jwts.builder()
            ...
            .signWith(SignatureAlgorithm.HS256,
                      "c2VjcmV0LWtleWFiY2RlZmdoaWprbG1ub3BxcnN0dXh2eg==")
            .compact();
    ...
    String token2 =
        Jwts.builder()
            ...
            .signWith(SignatureAlgorithm.HS256,
                      "c2VjcmV0LWtleWFiY2RlZmdoaWprbG1ub3BxcnN0dXh2eg==")
            .compact();
    AuthenticationResponse expectedResponse2 =
        new AuthenticationResponse(token2);
    ...
    AuthenticationRequest authRequest2 =
        new AuthenticationRequest(request2.getEmail(), request2.getPassword());
