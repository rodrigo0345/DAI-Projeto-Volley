...
public class PracticeController {
  ...
  createPractice(Long teamID, String local, LocalDateTime startDate,
    ...
    Practice newPractice =
        PracticeService
            .createPractice(practiceRepository, team, local, startDate, endDate)
            .success;
  ...
  public ResponseEntity<ResponseType<Practice>>
  editPractice(LoginUser loginUser, String local, LocalDateTime startDate,
               LocalDateTime endDate, Long practiceID) {
