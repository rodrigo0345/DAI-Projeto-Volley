...
public class PracticeController {
     ...
     * 
     * Practice newPractice = PracticeService.createPractice(practiceRepository,
     * teamID, startDate,
     * endDate).success;
     * 
     * var response = new ResponseType<Practice>();
     ...
     * Integer teamID,
     * String local, LocalDateTime startDate, LocalDateTime endDate, Integer
     * practiceID) {
     * 
     ...
     * }
     * 
     * Practice addedPlayers = CallsService.addPlayers(atletas, convocatoriaID,
     ...
     * }
     * 
     * public ResponseEntity<ResponseType<Practice>> removePlayer(LoginUser
     * loginUser,
     ...
     * }
     * 
     * Practice removedPlayers = CallsService.removePlayers(atletasId,
     * convocatoriaId,
     * convocatoriasRepository).success;
     * 
     * var response = new ResponseType<Practice>();
