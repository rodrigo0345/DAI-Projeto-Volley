...
public class CalendarService {
  ...
  getAllEvents(RideRepository rideRepo, NewsRepository newsRepo,
               GameRepository gameRepo, PracticeRepository practiceRepo,
               PhysicalAppointmentRepository appointmentRepo,
               TeamRepository teamRepo) {

    List<PostType> posts =
        fetchPosts(rideRepo, newsRepo, gameRepo, practiceRepo, appointmentRepo);
  ...
  public static List<Event>
  getAllTrainingEvents(RideRepository rideRepo, NewsRepository newsRepo,
                       GameRepository gameRepo, PracticeRepository practiceRepo,
                       PhysicalAppointmentRepository appointmentRepo) {
  ...
  public static List<Event>
  getEventsByUser(Integer id, RideRepository rideRepo, NewsRepository newsRepo,
                  GameRepository gameRepo, PracticeRepository practiceRepo,
                  PhysicalAppointmentRepository appointmentRepo,
  ...
  private static List<PostType>
  fetchPosts(RideRepository rideRepo, NewsRepository newsRepo,
             GameRepository gameRepo, PracticeRepository practiceRepo,
             PhysicalAppointmentRepository appointmentRepo) {
    // fetch all the data
  ...
  public static class RetrieveNews extends Thread {
    ...
    public List<PostType> getResult() { return this.result; }
  }
