...
public class CalendarService {
  public static boolean createEvent(CalendarRepository calendarRepository,
                                    PostType post) {
  ...
  public static boolean deleteEvent(CalendarRepository calendarRepository,
                                    PostType post) {
    if (post.getType().equals("ride")) {
      Ride ride = post.returnType();
  ...
  public static boolean subscribeEvent(CalendarRepository calendarRepository,
  ...
  public static boolean unsubscribeEvent(CalendarRepository calendarRepository,
  ...
  public static List<CalendarEvent>
  getAllEvents(CalendarRepository calendarRepository) {
