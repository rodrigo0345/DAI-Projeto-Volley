...
public class PracticeService {
  ...
  public static ResponseType<Practice>
  createPractice(PracticeRepository practiceRepository, Long team, String local,
  ...
  public static ResponseType<Practice>
  removePratice(PracticeRepository practiceRepository, Practice practice) {
  ...
  public static ResponseType<Practice>
  editPratice(PracticeRepository practiceRepository, Practice practice,
